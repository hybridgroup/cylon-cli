...
module.exports = {
  ...
  robot: function(args) {
    ...
    var name = args[0],
        dest = path.join(process.cwd(), name).replace(/(\s)/, "\\ "),
        template = path.join(__dirname, "support/generate/robot").replace(/(\s)/, "\\ ");
  ...
  tessel: function(args) {
    ...
    var name = args[0],
        dest = path.join(process.cwd(), name).replace(/(\s)/, "\\ "),
        template = path.join(__dirname, "support/generate/tessel").replace(/(\s)/, "\\ ");
  ...
  driver: function(args) {
    ...
    var lib = path.join(process.cwd(), "lib").replace(/(\s)/, "\\ "),
        template = path.join(__dirname, "support/generate/driver/driver.js").replace(/(\s)/, "\\ ");
  ...
  module: function(args) {
    ...
    var template = path.join(__dirname, "support/generate/module").replace(/(\s)/, "\\ ");
